...
for line in sys.stdin:
    ...
    line = line.strip()
    dataRcv= line.split("=")
    if(int(dataRcv[2])==2): # this 3rd type differentiate where data comes from , which file
	titleMov[dataRcv[0]]=dataRcv[1]
...
print("Movie with top average rating Title: "+str(topMovTitle)+" Average_Rating: "+str(topM[1]))
